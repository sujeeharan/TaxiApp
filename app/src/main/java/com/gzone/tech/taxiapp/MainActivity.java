...
//        downloadFile(download_file_video+"1231.mp4");
        ...
        final File localdirectory[] = f.listFiles();
        ArrayList<String> localdirectory1 = new ArrayList<String>();
        for(int i=0;i<localdirectory.length;i++){
            localdirectory1.add(localdirectory[i].getName());
            Toast.makeText(this,localdirectory[i].getName() + "Check",Toast.LENGTH_LONG).show();
        }
        ...
        try{
            for(int x=0;x<videolist.size();x++) {
                ...
                if(!localdirectory1.contains(listname)){
